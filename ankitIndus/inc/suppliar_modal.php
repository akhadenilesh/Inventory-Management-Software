       ...
       <div class="modal-body">
         ...
         <form id="adsuppliarForm">
           <div class="row">
             ...
             <div class="col-md-6 col-lg-6">
               <div class="form-group">
                 <label for="sup_gstno">GST No :</label>
                 <input type="text" class="form-control" id="sup_gstno" placeholder="GST No" name="sup_gstno">
               </div>
             </div>
             <div class="col-md-6 col-lg-6">
               <div class="form-group">
             ...
             <div class="col-md-6 col-lg-6">
               <div class="form-group">
                 <label for="sup_gst_type">GST Type:</label>
                 <select class="form-control" name="sup_gst_type" id="sup_gst_type">
 ...
 <script>
   document.getElementById('sup_gstno').addEventListener('input', function() {
     const gstNo = this.value.trim();
     const gstTypeField = document.getElementById('sup_gst_type');

     if (gstNo.startsWith('27')) {
       gstTypeField.value = 'SGST';
     } else if (gstNo.length >= 2) {
       gstTypeField.value = 'IGST';
     } else {
       gstTypeField.value = ''; // Optional: reset if GST number is too short
     }
   });
 </script>