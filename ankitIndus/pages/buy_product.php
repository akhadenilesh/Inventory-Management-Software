            ...
            <div class="row">
              ...
              <div class="cl-md-3 col-lg-3">
                <div class="form-group">
                  ...
                  <input type="float" class="form-control" id="p_p_price" name="p_p_price" placeholder="Purchase price">
                </div>
              </div>
              <div class="cl-md-3 col-lg-3">
                <div class="form-group">
              ...
              <div class="cl-md-3 col-lg-3">
                <div class="form-group">
                  ...
                  <input type="float" class="form-control" id="p_p_sell_price" name="p_p_sell_price" placeholder="Sell price">
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="card" style="background: #f1eaea40;">
                  <div class="card-body">
                    <div class="form-group">
                      <div class="row">
                        <div class="col-md-3">
                          <label for="p_subtotal">Total</label>
                        </div>
                        <div class="col-md-8">
