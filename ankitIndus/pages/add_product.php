          ...
          <form id="addProduct">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select name="p_catagory" id="p_catagory" class="form-control">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select name="product_gst" id="product_gst" class="form-control">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="hnscode" placeholder="HNS Code" name="hnscode">
                </div>
              </div>
            ...
            <div class="col-md-4 col-lg-4">
              <div class="form-group">
                ...
                <input type="float" class="form-control" id="selling_price" placeholder="selling price" name="selling_price">
              </div>
            </div>
