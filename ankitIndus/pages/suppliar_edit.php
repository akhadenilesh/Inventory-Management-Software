                ...
                <div class="card-body">
                  ...
                  <form id="editSuppliarForm">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control add-member" id="sup_gstno" name="sup_gstno" value="<?= $data->sup_gstno; ?>">
                    </div>
                    <div class="form-group">
                      <label for="sup_gst_type">GST Type:</label>
                      <select class="form-control" name="sup_gst_type" id="sup_gst_type">
                        <option value="SGST" <?= $data->sup_gst_type == 'SGST' ? 'selected' : '' ?>>SGST</option>
                        <option value="IGST" <?= $data->sup_gst_type == 'IGST' ? 'selected' : '' ?>>IGST</option>
                      </select>
                    </div>
                    <div class="form-group">
