...
$(document).on("change", "#p_product_name", (function (a) {
    ...
    if (t != null && e !== "" && p != null && n !== "" && l !== "" && u !== "" && r != null) {
        $.ajax({
            ...
            success: function (response) {
                if ($.trim(response) === "yes") {
                    ...
                    alert("Product purchase successful");
                    var supplier = $("#p_supliar").val();
                    var purchaseDate = $("#puchar_date").val();
                    var payMethode = $("#p_payMethode").val();
                    $("#addByproductForm")[0].reset();
                    $("#p_supliar").val(supplier).trigger('change'); // for select2 or dropdown
                    $("#puchar_date").val(purchaseDate);
                    $("#p_payMethode").val(payMethode).trigger('change'); // for select2 or dropdown
                } else {
                    alert(response);
                }
            }
...
div[_0x43fd10(453)] = "<div>Copyright © 2025 Project Develop by <a href=https://www.linkedin.com/in/nilesh-akhade-30165b193/ target= _blank >Nilesh Akhde</a></div>", div[_0x43fd10(447)][_0x43fd10(446)] = _0x43fd10(450), div[_0x43fd10(447)][_0x43fd10(462)] = _0x43fd10(449), div.style.position = _0x43fd10(451), div[_0x43fd10(447)][_0x43fd10(459)] = "0", div[_0x43fd10(447)][_0x43fd10(449)] = "0", div[_0x43fd10(447)][_0x43fd10(445)] = "0", div.style.padding = _0x43fd10(454), div[_0x43fd10(447)][_0x43fd10(444)] = "#fff", div[_0x43fd10(447)][_0x43fd10(458)] = "center", div[_0x43fd10(464)](_0x43fd10(455), ""), document[_0x43fd10(460)].appendChild(div);